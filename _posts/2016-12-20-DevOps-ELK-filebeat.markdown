...
1. 新增各filebeat資料夾，並放置配置檔案：
    ...
    fusion_log:
        ...
        $ sudo mkdir -p /home/fusion-ap/fusion-filebeat && sudo mkdir -p /home/fusion-ap/fusion-filebeat-registry
        $ sudo vi /home/fusion-ap/fusion-filebeat/filebeat.yml

    fusion_log filebeat.yml內容：
    ...
    tomcat_log:
        ...
        $ sudo mkdir -p /home/fusion-ap/tomcat-filebeat && sudo mkdir -p /home/fusion-ap/tomcat-filebeat-registry
        $ sudo vi /home/fusion-ap/tomcat-filebeat/filebeat.yml

        $ sudo mkdir -p /home/fusion-ap/payara-filebeat && sudo mkdir -p /home/fusion-ap/payara-filebeat-registry
        $ sudo vi /home/fusion-ap/payara-filebeat/filebeat.yml

    tomcat_log filebeat.yml內容：
...
2. create sh script && run it !
    ...
    run_fusion-filebeat.sh內容：
        ...
        --restart=always \
        -v /home/fusion-ap/fusion-filebeat:/etc/filebeat \
        -v /home/fusion-ap/fusion-filebeat-registry:/etc/registry \
        -v /home/fusion-ap:/srv/fusion-ap \
        olinicola/filebeat:1.2.3

    run it!

        $ sudo chmod u+x run_fusion-filebeat.sh
        $ ./run_fusion-filebeat.sh
    ...
    tomcat_log:
        ...
        $ cd
        $ vi run_tomcat-filebeat.sh

    run_tomcat-filebeat.sh內容：

        #!/bin/bash
        docker rm -f tomcat-filebeat
        docker run --name tomcat-filebeat -itd \
        --restart=always \
        -v /home/fusion-ap/tomcat-filebeat:/etc/filebeat \
    ...
    run it!
        ...
        $ sudo chmod u+x run_tomcat-filebeat.sh
        $ ./run_tomcat-filebeat.sh
    ...
    payara_log:
        ...
        $ cd
        $ vi run_payara-filebeat.sh

    run_payara-filebeat.sh內容：

        #!/bin/bash
        docker rm -f payara-filebeat
        docker run --name payara-filebeat -itd \
        --restart=always \
        -v /home/fusion-ap/payara-filebeat:/etc/filebeat \
    ...
    run it!
        ...
        $ sudo chmod u+x run_payara-filebeat.sh
        $ ./run_payara-filebeat.sh
